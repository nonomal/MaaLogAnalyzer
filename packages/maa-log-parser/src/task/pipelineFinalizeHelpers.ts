...
import type { NestedActionGroup, NodeInfo, RecognitionAttempt } from '../shared/types'
...
export const finalizeTaskPipelineNodeEvent = (params: {
  ...
  const resolvedRecoDetails = fallbackRecoDetails ? wrapRaw(fallbackRecoDetails) : undefined
  ...
  const resolvedNodeDetails = params.details.node_details ? wrapRaw(params.details.node_details) : undefined
